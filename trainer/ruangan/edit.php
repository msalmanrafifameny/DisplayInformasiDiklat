...
<body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.10.0/dist/sweetalert2.all.min.js"></script>
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST") {
         ...
         $sql = "UPDATE ruangan SET nama_ruangan = '$nama_ruangan', ketersediaan = '$ketersediaan' where id_ruang = '$idToUpdate'";
        if (mysqli_query($conn, $sql)) {
            echo '<script>
                    swal.fire({
                        title: "Sukses",
                        text: "Perubahan Data Ruangan Berhasil",
                        icon: "success",
