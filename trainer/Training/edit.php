...
if (isset($_GET['id_pelatihan'])) {
    $idToUpdate = $_GET['id_pelatihan'];
    $sqlGetData = "SELECT * FROM pelatihan WHERE id_pelatihan = '$idToUpdate'";
    $resultGetData = mysqli_query($conn, $sqlGetData);

    if ($resultGetData) {
        $rowData = mysqli_fetch_assoc($resultGetData);
        $judul_pelatihan = $rowData['judul_pelatihan'];
        $tanggal = $rowData['tanggal'];
        $jam = $rowData['jam'];
        $provider = $rowData['provider'];
        $instruktur = $rowData['Instruktur'];
        $lokal = $rowData['lokal'];
    }
}
?>
...
<body>
                                            ...
                                            <div class="row gutters">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="judul_materi" id="judul_materi" placeholder="Nama Materi" value="<?php echo $judul_pelatihan; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row gutters">
                                            ...
                                            <div class="row gutters">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="instruktur" id="instruktur" placeholder="Instruktur" value="<?php echo $instruktur; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row gutters">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sqlt = "UPDATE pelatihan 
                 SET judul_pelatihan = '$judul_materi', tanggal = '$tanggal', jam = '$jam', provider = '$provider', Instruktur = '$instruktur', lokal = '$lokal'
                 WHERE id_pelatihan = $idToUpdate";

        if (mysqli_query($conn, $sqlt)) {
            echo '<script>
                    swal.fire({
                        title: "Sukses",
                        text: "Perubahan Data Pelatihan Berhasil",
                        icon: "success",
